...
const TVRow = ({ title, category, linkTo = "/tv" }) => {
  ...
  // Ensure buttons are updated when items are loaded/changed
  useEffect(() => {
          ...
          return (
            <div className="card" key={it.id}>
              ...
              <button
                ...
                onClick={() => (fav ? removeFavourite(it.id) : addFavourite({ id: it.id, media_type: 'tv', poster_path: it.backdrop_path || null, name: it.name || null, first_air_date: it.first_air_date || null }))}
              >
